          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative">
            ...
            <div>
              <div className="flex justify-between items-end mb-1.5">
                ...
                <span className="text-[10px] font-black text-black/50">{formData.name.length}/100</span>
              </div>
              <input
                id="chabeel-name"
                required
            ...
            <div>
              <div className="flex justify-between items-end mb-1.5">
                ...
                <span className="text-[10px] font-black text-black/50">{formData.description.length}/1000</span>
              </div>
              <textarea
                id="chabeel-desc"
                maxLength={1000}
